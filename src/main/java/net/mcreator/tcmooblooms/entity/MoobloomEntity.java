...
public class MoobloomEntity extends Animal implements IAnimatable {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MoobloomEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MoobloomEntity.class, EntityDataSerializers.STRING);
	...
	public MoobloomEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TcmoobloomsModEntities.MOOBLOOM.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MoobloomHoneyProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		MoobloomOnEntityTickUpdateProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MoobloomEntity retval = TcmoobloomsModEntities.MOOBLOOM.get().create(serverWorld);
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			if ((event.isMoving() || !(event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F))
				...
				event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.Moobloom.Walk", EDefaultLoopTypes.LOOP));
				return PlayState.CONTINUE;
			}
			if (this.isSprinting()) {
				event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.Moobloom.Sprint", EDefaultLoopTypes.LOOP));
				return PlayState.CONTINUE;
			}
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.Moobloom.Idle", EDefaultLoopTypes.LOOP));
			return PlayState.CONTINUE;
		}
