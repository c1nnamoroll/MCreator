...
public class TcmoobloomsModItems {
	...
	public static final RegistryObject<Item> MOOBLOOM_SPAWN_EGG = REGISTRY.register("moobloom_spawn_egg", () -> new ForgeSpawnEggItem(TcmoobloomsModEntities.MOOBLOOM, -146428, -528971, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
}
