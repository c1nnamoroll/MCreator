...
public class MoolipBreedingProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.isBaby() : false) && entity instanceof MoolipEntity) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new BabyMoolipEntity(TcmoobloomsModEntities.BABY_MOOLIP.get(), _level);
