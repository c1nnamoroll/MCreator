...
@Mod("tcmooblooms")
public class TcmoobloomsMod {
	public static final Logger LOGGER = LogManager.getLogger(TcmoobloomsMod.class);
	public static final String MODID = "tcmooblooms";

	public TcmoobloomsMod() {
